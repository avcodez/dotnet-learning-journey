...
/**Syntax	Valid?	Reason
string[] names = { "A", "B" };	✅	Array initializer shortcut
string[] names = new string[] { "A", "B" };	✅	Explicit creation
string[] names; names = { "A", "B" };	❌	No array object created
string[] names; names = new string[] { "A", "B" };	✅	Explicit creation after declaration
**/
...
{
    Console.WriteLine("Hello, " + name + "! from Greet function");
}
